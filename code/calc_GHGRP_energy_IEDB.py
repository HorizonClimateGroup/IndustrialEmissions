...
# removed because this takes a long time (2022)
            missingfips.loc[:, 'COUNTY_FIPS'] = 0
    ...
    def import_data(self, subpart):
        ...
        def download_or_read_ghgrp_file(subpart, filename):
            ...
            for y in self.years:
                ...
                ghgrp_data.columns=[x.upper() for x in list(ghgrp_data.columns)] 
...
# No removal of electric utilities (just first commented part, second part was commented in original)
